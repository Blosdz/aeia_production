...
@section('content')
    <div class="container bg-1 rounded p-4">
            ...
            <div class="card-body row payment-card">
                <div class="card mx-5 p-3 w-25" style="background-color: #1c2a5b; color:white">
                    ...
                    <div class="card-body text-center">
                        ...
                        <p>
                            <h1 class="" style="color: #eab226"><b>${{ $plan->minimum_fee }} a {{ $plan->maximum_fee ? '$'.$plan->maximum_fee : "más" }}</b></h1>
                        </p>
                ...
                <div class="card mx-5 p-3 w-50 bg-1 rounded">
        ...
        <div class="modal-dialog bg-1" role="document">
            <div class="modal-content bg-1">
                ...
                <div class="modal-footer">
                    ...
                    {!! Form::button('Ya realicé el pago', ['class' => 'btn btn-success', 'id' => 'submitButton']) !!}
                </div>
            </div>
        </div>
    </div>
