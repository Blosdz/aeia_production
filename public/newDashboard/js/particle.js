...
function toggleParticleColor(){
  $('#particle-js').addClass('toggle-color');
  $('#changeline').addClass('toggle-color');
  const newColor='#000';
...
particlesJS("particles-js", {
  "particles": {
    ...
    "color": {
      "value": "#1C305C" //" sacar del css var(--line-colors)" linecolors cambia cuando esta en modo oscuro
    },
    "shape": {
      "type": "circle",
      "stroke": {
  ...
  "interactivity": {
    ...
    "events": {
      ...
      "onclick": {
        "enable": true,
        "mode": "push",
        "limit": 110// Adding a custom limit property
      },
      "resize": true
    },
    "modes": {
