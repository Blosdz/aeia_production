    ...
    public function insurance_pay(Request $request)
{
    ...
    $insurance->phonenumber = $profile->phone_extension.'.'.$profile->phone; // Asumiendo que el usuario tiene un número de teléfono
    ...
    // Crear una nueva entrada en ClientInsurance
    ClientInsurance::create([
